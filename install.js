...
if (process.platform === 'win32') {
  ...
  switch (process.arch) {
    case 'x64':
      ...
      break;
    case 'ia32':
      get('https://www.johnvansickle.com/ffmpeg/old-releases/ffmpeg-4.0.3-32bit-static.tar.xz', callback);
      break;
    case 'arm':
      get('https://www.johnvansickle.com/ffmpeg/old-releases/ffmpeg-4.0.3-armhf-32bit-static.tar.xz', callback);
      break;
    default:
      throw new Error('unsupported platform');
  }
